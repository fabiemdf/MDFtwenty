...
Running on a DigitalOcean droplet with Plesk? Use the [Plesk pack](https://github.com/fabiemdf/MDFtwenty/tree/main/packages/twenty-docker/plesk) instead of exposing port 3000. It binds loopback, terminates TLS in Plesk, and documents droplet sizing. Do not compile this monorepo on the Plesk host.
