...
<CardGroup cols={2}>
  ...
  <Card title="Plesk on DigitalOcean" icon="server" href="https://github.com/fabiemdf/MDFtwenty/tree/main/packages/twenty-docker/plesk">
    Reverse-proxy a published image behind Plesk
  </Card>
</CardGroup>
